...
const api = {
  key: "75a599836d669134f706d92f5ff185e8",
...
const SearchBar = () => {
  ...
  const searchData = () => {
    if (city !== "") {
      ...
      setErr("Please Enter the City Name");
      setIsError(true);
      setTimeout(() => {
        setIsError(false);
      }, 3000);
  ...
  return (
    <div>
      <form>
        ...
        ></input>
        <button
          className="px-3 py-2 bg-slate-500 text-white cursor-pointer rounded-lg"
          onClick={(e) => {
            e.preventDefault();
            searchData();
          }}
